            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseForm" aria-expanded="false" aria-controls="collapseForm">
                        <i class="fas fa-plus-circle me-2"></i>Tambah Rencana Studi
                    </button>
                </div>
                <div class="card-body">
                    <!-- Quick Stats -->
                    <div class="row mb-4">
                        <div class="col-md-4 mb-2">
                            <div class="p-3 bg-light-primary rounded">
                                <h6 class="mb-2">Total Rencana Studi</h6>
                    ...
                    <div class="collapse" id="collapseForm">
                        <div class="card card-body border">
                            <h5 class="card-title mb-3">Tambah Rencana Studi Baru</h5>
                            <form action="{{ route($spref . 'akademik.kurikulum-handle') }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="name" class="form-label">Nama Rencana Studi</label>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#editData{{ $item->code }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="Edit Rencana Studi">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="{{ route($spref . 'akademik.kurikulum-delete', $item->code) }}" method="POST" class="d-inline" id="delete-form-{{ $item->code }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button" class="btn btn-sm btn-danger" data-confirm-delete="true" data-bs-toggle="tooltip" title="Hapus Rencana Studi" onclick="confirmDelete('{{ $item->code }}')">
        ...
        <div class="col-lg-4 col-12 mb-2">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Informasi Rencana Studi</h5>
                </div>
                <div class="card-body">
                    <p>Rencana Studi adalah seperangkat mata kuliah dan aturan yang berlaku pada suatu program studi dalam periode tertentu.</p>
                    
                    <div class="alert alert-light-success">
                        <h6 class="">Petunjuk Penggunaan:</h6>
                        <ul class="mb-0">
                            <li>Klik tombol "Tambah Rencana Studi" untuk menambahkan Rencana Studi baru</li>
                            <li>Klik ikon <i class="fas fa-edit"></i> untuk mengedit data Rencana Studi</li>
                            <li>Klik ikon <i class="fas fa-trash"></i> untuk menghapus Rencana Studi</li>
                        </ul>
                    </div>
                    
                    @if(count($kurikulum) > 0)
                        <div class="mt-4">
                            <h6>Rencana Studi Masih Berlaku</h6>
                ...
                <div class="modal-content">
                    <form action="{{ route($spref . 'akademik.kurikulum-update', $item->code) }}" method="POST">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="editModalLabel{{ $item->code }}">Edit Rencana Studi - {{ $item->name }}</h5>
                        ...
                        <div class="modal-body">
                             <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="edit_name{{ $item->code }}" class="form-label">Nama Rencana Studi</label>
    ...
    <script>
        ...
        function confirmDelete(code) {
            Swal.fire({
                ...
                text: "Data Rencana Studi yang dihapus tidak dapat dikembalikan!",
                icon: 'warning',
