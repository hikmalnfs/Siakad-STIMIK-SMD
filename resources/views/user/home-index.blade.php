                            ...
                            <a href="{{ route('web-admin.master.fakultas-index') }}">
                                <div class="card btn btn-outline-success">
                                    <div class="card-body d-flex justify-content-around align-items-center">
                                        ...
                                        <span class="text-putih" style="margin-left: 25px; font-size: 16px;">{{ \App\Models\Fakultas::all()->count() }} <br> Peguruan Tinggi </span>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="{{ route('web-admin.master.kurikulum-index') }}">
                                <div class="card btn btn-outline-success">
                                    <div class="card-body d-flex justify-content-around align-items-center">
                                        ...
                                        <span class="text-putih" style="margin-left: 25px; font-size: 16px;">{{ \App\Models\Kurikulum::all()->count() }}<br>Rencana Studi</span>
                                    </div>
                                </div>
                            </a>
                        </div>
